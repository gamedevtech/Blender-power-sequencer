            ...
            "SEQUENCE_EDITOR": {
                "WINDOW": {
                    ...
                    "power_sequencer.mouse_cut": {
                        "0": ["type=ACTIONMOUSE", "shift=True", "ctrl=True", "properties=function:Cut"],
                    ...
                    "power_sequencer.trim_to_surrounding_cuts": {
                        "0": ["type=ACTIONMOUSE", "alt=True", "shift=True"]
                    },
                    "power_sequencer.unspeed": {
                        "0": ["type=PLUS", "alt=True", "shift=True"]
                    }
                }
            }
        }
